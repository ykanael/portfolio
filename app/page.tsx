        ...
        <div className="md:w-1/2 space-y-6 z-10 w-full lg:relative lg:-top-70">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-4">
            <div className="flex items-center gap-3">
              <span className="xl:text-[1.24] text-[#D48D85] font-serif italic text-xl md:text-2xl border-r-2 border-[#D48D85] pr-2">
                {currentText}
              </span>
              <button
      ...
      <section className="relative max-w-5xl mx-auto px-6 pb-24">
        <div className="bg-white p-4 md:p-12 rounded-[2.5rem] md:rounded-[3rem] shadow-sm border border-[#F5E1DE] relative overflow-hidden">
          ...
          <div className="bg-[#fcebe8] border-l-4 border-[#D48D85] mt-5 p-4 lg:p-6 rounded-lg">
            <p className="xl:text-[1.3rem] text-sm lg:text-base text-gray-700 text-justify">
